...
Spent some time this morning working checking out C#... got a Udemy course, installed Microsoft Visual Studio...  got lost right off the bat, because the instructor was using Windows..finding things was weird...  felt out of it from the start, so I am going back to Javascript and for now I'm going to focus on Front End Development.  
